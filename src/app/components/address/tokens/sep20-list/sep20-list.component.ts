...
import { Erc20ResourceService, IErc20Contract } from 'src/app/services/resources/erc20/erc20-resource.service';
...
export class AddressSEP20ListComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    this.activeTxs = [];
    this.activeErc20Contract = undefined;
  ...
  setActiveTab($event: MatTabChangeEvent) {
    const contract = find(this.erc20contracts, {symbol: $event.tab.textLabel});
